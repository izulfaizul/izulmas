                ...
                wawancara = input.nextDouble();
                    ...
                    {if(hasilandroid.hasil(tulis,koding,wawancara)<85){
                        System.out.println("Nilai Akhir : "+hasilandroid.hasil(tulis,koding,wawancara));
                            ...
                            System.out.println("Mohon Maaf, kepada  telah ditolak sebagai anggota android");
                            
                        }
                        else{
                            System.out.println("Nilai Akhir : "+hasilandroid.hasil(tulis,koding,wawancara));
                            System.out.println("Keterangan : Lolos");
                            System.out.println("Selamat, Tim  telah diterima sebagai anggota android ");
                        }
                    }
                ...
                wawancara = input.nextDouble();
                    ...
                    case 2 : 
                        ...
                        System.out.println("Nilai Akhir : "+web.hasil(tulis,koding,wawancara));
                            System.out.println("Keterangan : Gagal");
                            System.out.println("Mohon Maaf, kepada  telah ditolak sebagai anggota web");
                            
                        }
                        else{
                             System.out.println("Nilai Akhir : "+web.hasil(tulis,koding,wawancara));
                            System.out.println("Keterangan : Lolos");
                            System.out.println("Selamat, Tim telah diterima sebagai anggota web ");
                        }
